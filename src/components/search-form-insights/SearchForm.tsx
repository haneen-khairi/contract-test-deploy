        ...
        <FormControl flexGrow="1" w={"220px"}>
          ...
          >
            {typesList.map((typeItem) => {
              return (
                <option selected={getValues("type") == typeItem.id} key={typeItem.id} value={typeItem.id}>
                  {typeItem.name}
                </option>
              );
            })}
        ...
        <FormControl flexGrow="1" w={"220px"}>
          ...
          >
            {statusList.map((stateItem) => {
              return (
                <option selected={getValues("status") == stateItem.id} key={stateItem.id} value={stateItem.id}>
                  {stateItem.name}
                </option>
              );
            })}
