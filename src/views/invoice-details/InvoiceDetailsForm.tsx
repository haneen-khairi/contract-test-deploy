...
function InvoiceDetailsForm({
  ...
  const handleItemChange = (index: number, newItem: InvoiceItem) => {
    console.log("::top level",index, newItem);
  ...
  return (
    <>
      ...
      <Flex flexWrap="wrap" gap={"12px"} justify={"space-between"}>
        ...
        <FormControl flexGrow="1" w={"220px"} isInvalid={!!errors.number}>
          <FormLabel fontSize={"12px"} fontWeight={"700"}>
            Invoice Number
          </FormLabel>
          <Input {...register("number", { valueAsNumber: true })} placeholder="Invoice Number" />
          <FormErrorMessage>
        ...
        <FormControl flexGrow="1" w={"220px"} isInvalid={!!errors.date}>
          ...
          <Input type="date" {...register("date")} placeholder="Invoice Date" />
          <FormErrorMessage>
      ...
      <Flex flexWrap="wrap" gap={"12px"} mt={{ md: "24px", sm: "18px" }}>
        <FormControl isInvalid={!!errors.billed_from} flexGrow="1" w={"220px"}>
          <FormLabel fontSize={"12px"} fontWeight={"700"}>
            Billed From
          </FormLabel>
        ...
        <FormControl isInvalid={!!errors.billed_to} flexGrow="1" w={"220px"}>
          <FormLabel fontSize={"12px"} fontWeight={"700"}>
            Billed To
          </FormLabel>
      ...
      <Flex flexWrap="wrap" gap={"12px"}>
        <FormControl flexGrow="1" w={"220px"} isInvalid={!!errors.discount}>
          <FormLabel fontSize={"12px"} fontWeight={"700"}>
            Discount
          </FormLabel>
          <Input type="number" {...register("discount")} placeholder="Discount Value" />
          <FormErrorMessage>
        ...
        <FormControl flexGrow="1" w={"220px"} isInvalid={!!errors.tax}>
          ...
          <Input type="number" {...register("tax", { valueAsNumber: false })} placeholder="Tax Percentage" />
          <FormErrorMessage>
      ...
      <FormControl maxW={"100%"} mt={{ md: "24px", sm: "18px" }}>
        ...
        <Input type="text" value={total} isDisabled opacity={"0.75 !important"} />
      </FormControl>
    </>
  );
}
